...
public class FinalRouteDeliveryTests
{
    private readonly Mock<IInboxWriter> _inboxWriterMock;
    private readonly FinalRouteDelivery _sut;

    public FinalRouteDeliveryTests()
    {
        _inboxWriterMock = new Mock<IInboxWriter>();
        _sut = new FinalRouteDelivery(_inboxWriterMock.Object);
    }

    [Fact]
    public void CanDeliver_WithFinalStepBeingNextInRoute_ReturnsTrue()
    {
        // Arrange
    ...
    [Fact]
    public async Task DeliverAsync_WithFinalStepBeingNextInRoute_DeliversTheEvent()
    {
        // Arrange
        var finalStep = FinalRouteStep.Create();
        SerializedRoutedEvent routedEvent = CreateRoutedEvent(finalStep);
        ...
        // Assert
        _inboxWriterMock.Verify(iw => iw.Write(routedEvent, cancellationToken));
    }
