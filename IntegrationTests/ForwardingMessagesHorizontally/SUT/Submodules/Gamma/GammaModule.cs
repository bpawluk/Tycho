using IntegrationTests.ForwardingMessagesHorizontally.SUT.Submodules.Gamma.Handlers;
...
namespace IntegrationTests.ForwardingMessagesHorizontally.SUT.Submodules.Gamma;
