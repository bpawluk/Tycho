...
internal class AppModule : TychoModule
{
    protected override void HandleIncomingMessages(IInboxDefinition module, IServiceProvider services)
    {
        ...
        module.Events.Handle(new HandledByHandlerInstanceEventHandler(thisModule))
              .Events.Handle<HandledByHandlerTypeEvent, HandledByHandlerTypeEventHandler>();

        module.Requests.Handle(new HandledByHandlerInstanceRequestHandler(thisModule))
              .Requests.Handle<HandledByHandlerTypeRequest, HandledByHandlerTypeRequestHandler>();

        module.Requests.Handle(new HandledByHandlerInstanceRequestWithResponseHandler(thisModule))
    ...
    {
        module.Events.Declare<HandledByHandlerInstanceEvent>()
              .Events.Declare<HandledByHandlerTypeEvent>();

        module.Requests.Declare<HandledByHandlerInstanceRequest>()
              .Requests.Declare<HandledByHandlerTypeRequest>();

        module.Requests.Declare<HandledByHandlerInstanceRequestWithResponse, string>()
