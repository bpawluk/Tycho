...
namespace Tycho.Modules
{
    ...
    {
        /// <summary>
        /// Declares that the module will handle all events of type <typeparamref name="TEvent"/>
        ...
        /// <summary>
        /// Declares that the module will route all events of type <typeparamref name="TEvent"/>
